...
function shownotesshortcode_add_styles() {
  ...
  wp_enqueue_style('shownotesstyle', plugins_url('static/' . $css_styles[$shownotes_options['css_id']] . '.css', __FILE__), array(), '0.3.4');
}
...
function add_shownotes_textarea($post) {
  ...
  echo '<div id="add_shownotes" class="shownotesdiv"><script>var shownotesname = \'' . $shownotesname . '\';</script><p><textarea id="shownotes" name="shownotes" style="height:280px" class="large-text">' . $shownotes . '</textarea></p> <p>ShowPad Import: ' . $baseurlstring . ' &#124; Preview: <input type="submit" class="button" onclick="previewPopup(document.getElementById(\'shownotes\'), \'html\', false, \''.plugins_url('api.php' , __FILE__ ).'\'); return false;" value="HTML"> <input type="submit" class="button" onclick="previewPopup(document.getElementById(\'shownotes\'), \'chapter\', false, \''.plugins_url('api.php' , __FILE__ ).'\'); return false;" value="Chapter"> &#124; Download:  <input type="submit" class="button" onclick="previewPopup(document.getElementById(\'shownotes\'), \'chapter\', true \''.plugins_url('api.php' , __FILE__ ).'\'); return false;" value="Chapter"> </p></div>';
}
...
function shownotesshortcode_add_admin_scripts() {
  wp_enqueue_script('majax', plugins_url('static/majaX/majax.js', __FILE__), array(), '0.3.4', false);
  wp_enqueue_script('importPad', plugins_url('static/shownotes_admin.js', __FILE__), array(), '0.3.4', false);
  wp_enqueue_script('tinyosf', plugins_url('static/tinyOSF/tinyosf.js', __FILE__), array(), '0.3.4', false);
  wp_enqueue_script('tinyosf_exportmodules', plugins_url('static/tinyOSF/tinyosf_exportmodules.js', __FILE__), array(), '0.3.4', false);
}
function shownotesshortcode_add_scripts() {
  wp_enqueue_script('importPad', plugins_url('static/shownotes.js', __FILE__), array(), '0.3.4', false);
}
if (is_admin()) {
